...
/* tagging */
static const char *tags[] = { "1: music", "2: chat", "3: www", "4", "5", "6", "7", "8", "9" };
...
/* key definitions */
#define MODKEY Mod4Mask //Mod4 i.e. win/super key
...
static const char *nnncmd[]  = { "alacritt", "-e", "nnn -denA -T t", NULL };
static const char *powermenucmd[]  = { "~/.config/rofi/powermenu/type-1/powermenu.sh", NULL };
